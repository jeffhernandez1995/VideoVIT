...
./distributed_train.sh 2 datasets/imagenet --model vit_small_patch16_224 --sched cosine --epochs 300 --opt adamw -j 12 --warmup-lr 1e-6 --model-ema --model-ema-decay 0.99996 --amp --lr 5e-4 --weight-decay .05 --drop 0.1 --drop-path .1 -b 512 --log-wandb
