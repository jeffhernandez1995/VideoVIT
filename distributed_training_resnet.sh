...
python train_imagenet.py --config-file rn50_16_epochs.yaml \
    --data.train_dataset=datasets/imagenet/train_500_1_90.ffcv \
    --data.val_dataset=datasets/imagenet/validation_500_1_90.ffcv \
    --data.num_workers=12 --data.in_memory=1 \
    --logging.folder=output/